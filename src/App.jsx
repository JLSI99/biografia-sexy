    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans p-6 md:p-20 selection:bg-blue-500/30">
        ...
        >
          <div className="relative group">
            ...
            <img 
              src={miFoto} 
              alt="Jorgito" 
              className="relative w-48 h-48 md:w-64 md:h-64 rounded-full object-cover border-2 border-slate-800 grayscale hover:grayscale-0 transition-all duration-700 shadow-2xl"
            />
          </div>
        </motion.div>

        <p className="mt-8 text-2xl md:text-3xl text-slate-400 font-light tracking-wide max-w-2xl mx-auto">
          Ingeniero de Sistemas. <span className="text-white">Estratega Digital.</span> Arquitecto de lo invisible.
        </p>
      </motion.header>
      ...
      <main className="max-w-5xl mx-auto mt-24 grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
        ...
        <motion.section 
          ...
          className="space-y-8"
        >
          <h2 className="text-4xl font-bold text-white tracking-tight">La Filosofía</h2>
          <p className="text-xl leading-relaxed text-slate-400">
            No me conformo con lo funcional; busco lo <span className="text-blue-400">trascendental</span>. 
            Mi enfoque combina la precisión del hardware con la fluidez de una narrativa poética.
          </p>
          <div className="bg-slate-900/80 p-8 rounded-xl border-l-8 border-blue-600 shadow-inner">
            <p className="text-lg italic text-slate-300">
              "El código es el lenguaje en el que escribo el futuro. Cada línea es un compromiso con la excelencia."
            </p>
          </div>
        </motion.section>
        ...
        >
          <h3 className="text-2xl font-semibold mb-8 text-blue-500 uppercase tracking-widest">Core Intelligence</h3>
